...
class TestDHS():
    ...
    def test_generate_datasets_and_showcase(self, configuration, downloader):
        with temp_dir('DHS') as folder:
            ...
            assert bites_disabled == {'national': [False, False, False], 'subnational': [True, False, False]}
